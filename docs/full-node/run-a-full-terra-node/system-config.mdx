...
| ---------------------------------------------------------------------- | -------------- | ----- | -------------------------- | --------- |
| [`columbus-5`](join-a-network.mdx#join-a-public-network)               | 4 (+4 threads) | 32 GB | 2 TB (SSD 2000 MB/s R/W)   | 300 Mbps  |
| [`rebel-2`](join-a-network.mdx#join-a-public-network)                  | 2 (+2 threads) | 16 GB | 500 GB (SSD 1000 MB/s R/W) | 150 Mbps  |
| [`localterra`](https://github.com/classic-terra/localterra)            | 2              | 4 GB  | 20 GB (SSD 500 MB/s R/W)   | N/A       |
