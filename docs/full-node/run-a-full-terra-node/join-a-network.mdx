...
In order for Terrad to recognize a wallet address, it must contain tokens. For the testnet, use [the faucet](https://faucet.terra.money/) to send Lunc to your wallet. If you are on mainnet, send funds from an existing wallet. 1-3 Lunc are sufficient for most setup processes.
...
| :----------- | :------ | :----------------------------------------------------------------------------------------------- | :------------------------------------------------------------------------------------------------------------ | :------------------------------------------------------------------------- |
| `columbus-5` | Mainnet | [Genesis Link](https://columbus-genesis.s3.ap-northeast-1.amazonaws.com/columbus-5-genesis.json) |  [Peer List](https://raw.githubusercontent.com/classic-terra/classic-mainnet/master/columbus-5/addrbook.json) | [Seeds List](https://github.com/classic-terra/classic-mainnet#seed-nodes)  |
| `rebel-2`    | Testnet | [Genesis Link](https://network-rebel-2.s3.amazonaws.com/bajor-1/genesis.json)                    |  [Peer List](https://raw.githubusercontent.com/classic-terra/documents/main/bajor-1/addrbook.json)            |  |
...
```bash
# Obtain the genesis for columbus-5:
wget https://columbus-genesis.s3.ap-northeast-1.amazonaws.com/columbus-5-genesis.json -O ~/.terra/config/genesis.json

# Obtain the addressbook for columbus-5:
wget https://raw.githubusercontent.com/classic-terra/classic-mainnet/master/columbus-5/addrbook.json -O ~/.terra/config/addrbook.json
