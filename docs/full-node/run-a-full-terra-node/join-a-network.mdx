...
| :----------- | :------ | :----------------------------------------------------------------------------------------------- | :---------------------------------------------------------------------------------------------------- | :----------------------------------------------------------------- |
| `columbus-5` | Mainnet | [Genesis Link](https://columbus-genesis.s3.ap-northeast-1.amazonaws.com/columbus-5-genesis.json) |  [Peer List](https://raw.githubusercontent.com/classic-terra/mainnet/master/columbus-5/addrbook.json) | [Seeds List](https://github.com/classic-terra/mainnet#seed-nodes)  |
...
wget https://raw.githubusercontent.com/classic-terra/mainnet/master/columbus-5/addrbook.json -O ~/.terra/config/addrbook.json
```
