...
To sync a Rebel-2 testnet node, you will need to use version `v2.0.0-rc.0` of terrad up until the block height of `838,500`. To sync your node from block 838,500 until block 2,777,777, you will need to use version `v2.1.0-beta.1` of terrad. From block 2,777,777 until 4,712,048, use version `v2.2.0` of terrad. From block 4,712,048 onwards, use `v2.3.0-rc.0`
...
7. To sync your Pisco testnet node from block 2,777,777 to block 4712048, you will need to navigate to the `core` directory and change your terrad version to `v2.2.0`.
